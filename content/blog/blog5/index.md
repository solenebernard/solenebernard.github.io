...
We can start by a straight forward observation: we have the sensation of sound frequency. When we hear a music, we hear the pitch. Human created a music system by associating notes to specific range of frequencies, and designed music instrument to produce sound whose main harmonic matches a specific frequency.
